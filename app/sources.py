...
SOURCES: tuple[Source, ...] = (
    ...
    Source(
        ...
        "https://www.hsguru.com/meta?format=2&rank=top_5k",
        "hsguru",
        "meta",
        description="HSGuru meta, format=2, top 5k.",
    ),
    Source(
        "hsguru_meta_standard_top_legend",
        "https://www.hsguru.com/meta?format=2&rank=top_legend",
        "hsguru",
        "meta",
        description="HSGuru meta, format=2, top legend.",
    ),
    Source(
